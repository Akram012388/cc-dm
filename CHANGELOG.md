...
### Fixed
- Ghost name theft protection — `onGhost` callback checks `findSessionsByName` before re-registering; falls back to auto-generated session ID if the name was taken during the ghost window
